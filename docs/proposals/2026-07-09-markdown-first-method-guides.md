...
| DQ4 | The first Pareto kit proves the model with `README.md`, primary `guide.md`, worked example, sample data, and support material for reviewed good/bad examples and prompts. Evidence-note fields live in the primary guide for this compact first slice. |
