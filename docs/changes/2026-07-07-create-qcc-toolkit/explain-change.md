...
| PPTX assets are binary and harder to review than Markdown. | The catalog points at real PPTX files, while adjacent Markdown source notes and deterministic `tools/build_ppt_templates.py` keep the template structure reviewable and reproducible. |
