...
| R11-R15, R27 | T5, T8, T9; prompt and evidence-state checks | `method-kits/_template/support/image-prompts.md`, `method-kits/pareto-chart/support/image-prompts.md`, `method-kits/pareto-chart/support/teaching-examples.md`, `method-kits/pareto-chart/support/teaching-visuals/*.png` | Full pytest passed. Support material records conceptual-only image boundaries and reviewed binary teaching visuals are included. | pass |
| R16-R21 | T9, T10; evidence-note checks | `docs/evidence/evidence-levels.md`, `docs/evidence/evidence-note-template.md`, `method-kits/pareto-chart/guide.md` | Full pytest passed. Evidence template fields are covered in the primary guide by `tests/test_markdown_first_method_guidance.py`. | pass |
| R22 | T6 Pareto kit required assets | `method-kits/pareto-chart/guide.md`, `method-kits/pareto-chart/examples/*`, `method-kits/pareto-chart/support/*` | Full pytest passed. Pareto kit is compacted around one primary guide plus prompt and teaching-example support material. | pass |
