...
| R11-R15, R27 | T5, T8, T9; prompt and evidence-state checks | `method-kits/_template/support/image-prompts.md`, `method-kits/pareto-chart/support/image-prompts.md`, `method-kits/pareto-chart/support/teaching-examples.md` | Full pytest passed. Support material records conceptual-only image boundaries and no binary teaching visuals were added. | pass |
