...
| R11-R15, R27 | T5, T8, T9; prompt and evidence-state checks | `docs/templates/image-prompts.md`, `media/prompts/pareto-chart.md`, `media/pareto-chart/*.png` | Full pytest passed. Media records conceptual-only image boundaries and reviewed binary teaching visuals are included. | pass |
