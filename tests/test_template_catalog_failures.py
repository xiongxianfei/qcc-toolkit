...
def _valid_entry(**overrides: object) -> dict[str, object]:
    entry: dict[str, object] = {
        ...
        "method_kit_status": "available",
        "method_kit": "method-kits/pareto-chart.md",
        "markdown_guide": "method-kits/pareto-chart.md",
...
def test_catalog_validation_fails_for_duplicate_template_id(tmp_path: Path) -> None:
    ...
    _write_catalog(
        ...
        _valid_entry(
            ...
            file="templates/ppt/methods/check-sheet-template.pptx",
            source_file="templates/ppt/sources/check-sheet.md",
            method_kit_status="available",
            method_kit="method-kits/check-sheet.md",
            markdown_guide="method-kits/check-sheet.md",
        ...
        _valid_entry(
            ...
            file="templates/ppt/methods/5w2h-template.pptx",
            source_file="templates/ppt/sources/5w2h.md",
            method_kit_status="available",
            method_kit="method-kits/five-w-two-h.md",
            markdown_guide="method-kits/five-w-two-h.md",
            python_assist_status="unavailable",
            python_assist_reasons=[],
            supports_generated_chart=False,
            chart_editability=None,
...
def test_catalog_allows_incoming_source_entry_without_official_ownership(
    ...
    _write_catalog(
        ...
        _valid_entry(
            ...
            method_kit_status="available",
            method_kit="method-kits/fishbone-diagram.md",
            markdown_guide="method-kits/fishbone-diagram.md",
            python_assist_status="unavailable",
            python_assist_reasons=[],
            supports_generated_chart=False,
